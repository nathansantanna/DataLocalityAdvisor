...
namespace DataLocalityRefactor
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(DataLocalityRefactorCodeRefactoringProvider)), Shared]
    internal class DataLocalityRefactorCodeRefactoringProvider : CodeRefactoringProvider
    {
